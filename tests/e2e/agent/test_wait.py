...
class TestVisionAgentWait:
    ...
    def test_wait_for_element_appear_success(
        ...
        vision_agent._default_locate_model.locate = Mock(
            wraps=vision_agent._default_locate_model.locate
        )
        ...
        assert vision_agent._default_locate_model.locate.call_count == 2
    ...
    def test_wait_with_locator_object(
        ...
        assert vision_agent._default_locate_model.locate.call_count >= 1
    ...
    def test_wait_disappear_timing(
        ...
        assert vision_agent._default_locate_model.locate.call_count == 3
