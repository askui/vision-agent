...
from askui.tools.askui.askui_android_controller import AskUiAndroidController
...
class AndroidVisionAgent:
    ...
    def __init__(
        ...
        self.os = AskUiAndroidController()
        self._reporter = CompositeReporter(reporters=reporters)
        self._model_router = ModelRouter.build_default_android_router(
            os=self.os,
