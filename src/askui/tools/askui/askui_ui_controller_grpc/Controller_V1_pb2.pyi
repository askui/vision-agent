...
class ProcessInfo(_message.Message):
    ...
    def __init__(
        ...
        ID: _Optional[int] = ...,
        name: _Optional[str] = ...,
        extendedInfo: _Optional[_Union[ProcessInfoExtended, _Mapping]] = ...,
    ) -> None: ...
...
class Response_GetWindowList(_message.Message):
    ...
    def __init__(
        self, windows: _Optional[_Iterable[_Union[WindowInfo, _Mapping]]] = ...
    ) -> None: ...
...
class Request_SetActiveWindow(_message.Message):
    ...
    windowID: int
    def __init__(
        self, processID: _Optional[int] = ..., windowID: _Optional[int] = ...
    ) -> None: ...
...
class AutomationTarget(_message.Message):
    ...
    def __init__(
        self,
        ID: _Optional[int] = ...,
        type: _Optional[_Union[AutomationTargetType, str]] = ...,
        name: _Optional[str] = ...,
        active: bool = ...,
    ) -> None: ...
...
class Response_GetAutomationTargetList(_message.Message):
    ...
    def __init__(
        self, targets: _Optional[_Iterable[_Union[AutomationTarget, _Mapping]]] = ...
    ) -> None: ...
