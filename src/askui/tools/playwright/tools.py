    ...
    def __init__(self, agent_os: PlaywrightAgentOs) -> None:
        super().__init__(
            ...
            description=(
                ...
                This will load the webpage at the given URL and make it the current page.
                The browser will wait for the page to load completely before proceeding.
                """
            ),
            input_schema={
                "type": "object",
    ...
    def __init__(self, agent_os: PlaywrightAgentOs) -> None:
        super().__init__(
            ...
            description=(
                ...
                If there is no previous page in the history, this action will have no effect.
                """
            ),
        )
        self._agent_os = agent_os
    ...
    def __init__(self, agent_os: PlaywrightAgentOs) -> None:
        super().__init__(
            ...
            description=(
                ...
                If there is no next page in the history, this action will have no effect.
                """
            ),
        )
        self._agent_os = agent_os
    ...
    def __init__(self, agent_os: PlaywrightAgentOs) -> None:
        super().__init__(
            ...
            description=(
                ...
                This returns the full URL including protocol, domain, path, and query parameters.
                """
            ),
        )
        self._agent_os = agent_os
