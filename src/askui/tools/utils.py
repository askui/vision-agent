...
def wait_with_progress(
    ...
    """
    Wait for a duration while printing a progress bar to stdout.

    Args:
        wait_duration (float): Total time to wait in seconds.
        message (str, optional): Label shown next to the progress bar.
            Defaults to "Waiting".
        refresh_interval (float, optional): How often to update the bar in
            seconds. Defaults to 0.2.
        progress_bar_width (int, optional): Width of the bar in characters.
            Defaults to 30.
    """
